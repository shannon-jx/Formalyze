// // sections/Dashboard/NavigationCard.js
// import React from 'react';
// import './NavigationCard.css';

// const NavigationCard = ({ title, children }) => {
//   return (
...
// src/sections/SurveyList/components/FormNavigation.js
import React, { useState, useEffect } from 'react';
import { doc, getDoc } from 'firebase/firestore';
import { db } from '../firebase'; // Adjust the path based on actual location
import { getAuth } from 'firebase/auth';
import './NavigationCard.css'; // Create and style as needed

function NavigationCard({ setCurrentView }) {
